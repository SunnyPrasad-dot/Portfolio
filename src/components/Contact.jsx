                    ...
                    <div className="lg:w-1/3 flex flex-col gap-8">
                        ...
                        <div className="flex gap-4 items-start group">
                            ...
                            <div>
                                ...
                                <a href="tel:+917984431659" className="text-gray-400 hover:text-blue-400 transition-colors block">+91 7984431659</a>
                            </div>
                        </div>
                        ...
                        <div className="flex gap-4 items-start pt-2 border-t border-gray-700/50">
                            <div className="w-full">
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <a href="https://wa.me/917984431659?text=Hello%20Sunny%2C%20I%20would%20like%20to%20discuss%20a%20project." target="_blank" rel="noopener noreferrer" className="w-11 h-11 rounded-xl bg-gray-900/50 shadow-[inset_0_2px_4px_rgba(0,0,0,0.3)] border border-gray-700 flex items-center justify-center text-gray-300 hover:bg-green-600/20 hover:border-green-500/50 hover:text-green-400 hover:-translate-y-1 transition-all" aria-label="WhatsApp"><i className="fab fa-whatsapp text-lg"></i></a>
                                </div>
                            </div>
                        </div>
