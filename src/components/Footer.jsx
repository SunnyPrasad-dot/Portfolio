                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12 border-b border-gray-800 pb-12">
                    <div className="md:col-span-2">
                        ...
                        <div className="flex gap-4">
                            ...
                            <a href="https://wa.me/917984431659?text=Hello%20Sunny%2C%20I%20would%20like%20to%20discuss%20a%20project." target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl bg-gray-800 flex items-center justify-center text-gray-400 hover:bg-green-600 hover:text-white transition-all duration-300 hover:-translate-y-1 shadow-[0_4px_10px_rgba(0,0,0,0.1)] border border-gray-700" aria-label="WhatsApp">
