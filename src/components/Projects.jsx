        ...
        <section id="projects" className="py-20 bg-gray-800 border-t border-gray-700/50">
            <div className="container mx-auto max-w-7xl px-6">
                ...
                <div className="flex flex-wrap justify-center gap-3 mb-12" data-aos="fade-up">
                    ...
                    >All</button>
                    <button 
                        className={`filter-btn shadow-sm ${filter === 'client-work' ? 'active bg-blue-500 text-white shadow-[0_0_15px_rgba(59,130,246,0.4)]' : 'hover:bg-gray-700'}`} 
                        onClick={() => setFilter('client-work')}
                    >CLIENT WORK</button>
                    <button 
                        className={`filter-btn shadow-sm ${filter === 'personal-projects' ? 'active bg-blue-500 text-white shadow-[0_0_15px_rgba(59,130,246,0.4)]' : 'hover:bg-gray-700'}`} 
                        onClick={() => setFilter('personal-projects')}
