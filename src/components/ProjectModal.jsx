            ...
            >
                ...
                <div className="p-4 sm:p-6 overflow-y-auto w-full custom-scrollbar">
                    ...
                    <div className="project-details text-left w-full">
                        ...
                        {/* <h3 className="text-lg font-semibold mb-2 text-gray-200 mt-6">My Contribution</h3>
                        <p className="mb-4 text-gray-400 text-sm leading-relaxed">{project.myContribution}</p> */}
