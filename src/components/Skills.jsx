const skillGroups = [
    {
        ...
        focus: ['Component architecture', 'Responsive layouts', 'Interactive experiences'],
        skills: [
    ...
    },
    {
        ...
        icon: 'fas fa-server',
        accent: 'emerald',
        summary: 'APIs, authentication, integrations, and server-side logic for real-world applications.',
        focus: ['REST endpoints', 'Authentication', 'API integrations'],
        skills: [
    ...
    },
    {
        ...
        accent: 'amber',
        summary: 'Document modeling, and data access patterns for MERN apps.',
        focus: ['Document models', 'Data validation', 'Database integration'],
        skills: [
    ...
    },
    {
        ...
        icon: 'fas fa-tools',
        accent: 'purple',
        summary: 'Tools and workflows for building, testing, debugging, and deploying applications.',
        focus: ['Version control', 'API testing', 'Deployment workflows'],
        skills: [
